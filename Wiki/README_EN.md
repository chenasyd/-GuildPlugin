...
- Unified version configuration management,只需修改一个配置即可全局生效
- Fixed command execution errors
- Enhanced currency system, including A-coin automatic growth and C-coin quest system
- Optimized workflow file, resolved build artifact not found issue
- Completed GuildQuestModule quest system module
- SDK coverage increased to 100%
- Updated all documentation to latest status
...
- [ ] Guild shop
- [x] Guild quest system ✅
- [ ] Guild leaderboard
- [ ] Guild event system
- [ ] Guild storage
- [x] Guild announcement system ✅
